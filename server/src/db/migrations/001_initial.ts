...
// Contract §9. IDs string(36); hashes string(64); timestamps bigInteger (epoch ms); JSON as longtext.
...
export const INITIAL_TABLES = [
  'users', 'sessions', 'children', 'settings', 'documents', 'document_pages', 'document_files', 'ocr_results', 'annotations',
  'reading_progress', 'reading_sessions', 'ai_requests', 'ai_cache', 'safety_alerts', 'exercises', 'answers',
  'dictionary_cache', 'glossary_entries',
] as const;
