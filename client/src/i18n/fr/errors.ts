...
export const errors = {
  ...
  codes: {
    ...
    invalid_token: 'Ce lien n’est plus valable. Demandez un nouveau lien.',
    mail_unavailable: 'L’envoi d’e-mails n’est pas encore configuré sur le serveur.',
    current_session: 'Pour cet appareil, utilisez « Se déconnecter ».',
