 ...
 */
export async function relaunchTranscription(documentId: Id, pageIndexes?: number[]): Promise<RelaunchTranscriptionResponse> {
  const body: { documentId: Id; pageIndexes?: number[] } = { documentId };
