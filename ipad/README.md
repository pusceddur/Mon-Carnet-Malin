...
- Plugin Swift della voce: vive in `ios-app/plugins/native-speech/` ed e condiviso con l'app dell'App Store (voci, parola letta, interruzioni, schermo sempre acceso). Se lo avevi gia installato qui, rilancia `npm install`.
...
- Modifiche del plugin della voce o della configurazione: `npm run sync`, poi ▶︎ in Xcode.
